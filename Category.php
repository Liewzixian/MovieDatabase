...
<audio src="Images/background.mp3" type="audio/mp3" autoplay loop>
			...
			<br/>
	<div id="main-wrapper">
		<center><h2>Insert / Update / Delete Category</h2></center>
		...
		<div class="inner_container">
			...
			<?php
				if(isset($_POST['fetch_btn'])){
					...
					if($category_id=="")
					{
						echo '<script type="text/javascript">alert("Enter category_id to get Payment details")</script>';
					}
					else
					{
						...
						if($query_run)
						{
							if(mysqli_num_rows($query_run)>0)
							{
								...
								echo '<script type="text/javascript">alert("Invalid category_id")</script>';
							}
						}
						else{
			...
			<form action="Category.php" method="post">
				...
				<input type="number" placeholder="Enter category ID" name="category_id" value="<?php echo @$_POST['category_id'];?>" >
			...
			<?php
				...
				if(isset($_POST['insert_btn'])){
					...
					if($category_id=="" || $name=="" || $Last_update=="")
					{
						echo '<script type="text/javascript">alert("Insert values in all fields")</script>';
					}
					else{
						$query = "insert into category values($category_id,'$name','$Last_update')";
						$query_run=mysqli_query($con,$query);
						if($query_run)
						{
				...
				else if(isset($_POST['update_btn']))
				{
					...
					if($_POST['category_id']=="" || $_POST['name']=="" ||  $_POST['Last_update']=="")
					{
				...
				else if(isset($_POST['delete_btn']))
				{
					...
					{
						echo '<script type="text/javascript">alert("Enter category_id to delete Payment")</script>';
					}
				else{
						$category_id = $_POST['category_id'];
			...
			<a href ="categoryall.php" class ="btn_back2">Select All</a>
		</div>
	</div>
	<br/>
	<br/>
