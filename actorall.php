...
<audio src="Images/background.mp3" type="audio/mp3" autoplay loop>
      ...
      <center><h1>Actor Records</h1></center>
...
if ($query_run)
{
    if (mysqli_num_rows($query_run) > 0)
    {
        ...
        {
            echo "<tr>
            <td>" . $row["actor_ID"] . " </td><td> " . $row["first_name"] . "</td><td>" . $row["last_name"] . "</td><td> " . $row["last_update"] . "</td></tr>";
        }
    }
    else
    {
...
?>
<a href ="actor.php" class ="btn_back3">Back</a>
</table>
</div>
</div>
<br/>
