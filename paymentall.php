...
<audio src="Images/background.mp3" type="audio/mp3" autoplay loop>
      ...
      <center><h1>Payment Records</h1></center>
...
if ($query_run)
{
    if (mysqli_num_rows($query_run) > 0)
    {
        ...
        {
            echo "<tr><td>" . $row["payment_id"] . " </td><td> " . $row["rental_id"] . "</td><td>" . $row["amount"] . "</td><td> ". $row["payment_date"] . "</td><td> " . $row["last_update"] . "</td></tr>";
        }
    }
    else
    {
...
?>
<a href ="payment.php" class ="btn_back3">Back</a>
</table>
</div>
</div>
<br/>
