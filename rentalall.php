...
<audio src="Images/background.mp3" type="audio/mp3" autoplay loop>
      ...
      <center><h1>Rental Records</h1></center>
...
if ($query_run)
{
    if (mysqli_num_rows($query_run) > 0)
    {
        ...
        {
            echo "<tr><td>" . $row["rental_id"] . " </td><td> " . $row["rental_date"] . "</td><td>" . $row["inventory_id"] . "</td><td> ". $row["customer_id"] . "</td><td> ". $row["return_date"] . "</td><td> ". $row["staff_id"].
            "</td><td>". $row["last_update"] . "</td></tr>";
        }
    }
    else
    {
...
?>
<a href ="rental.php" class ="btn_back3">Back</a>
</div>
</div>
</table>
<br/>
